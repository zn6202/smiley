...
const TextStyle selectedDateStyle = TextStyle(
    fontSize: 26.0, color: Color(0xFF4C543E), fontWeight: FontWeight.w600);
            ...
            if (value.first != null) {
              setState(() {
                ...
                if (_isToday(selectedDate)) {
                  _fetchEmotionData(); // 當日期是今天時，獲取情緒數據
                } else {
                  emotionImages = [];
                }
              });
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return SingleChildScrollView(
                      child: Column(
                        children: [
                          Padding(
                            padding: EdgeInsets.only(left: 20.0, right: 20.0, bottom: 36.0),
                            child: Text(
