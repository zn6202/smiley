...
class _DataScreenState extends State<DataScreen> {
  ...
  Map<String, String> feedbackTexts = {
    "開心": "今天適合你的精油是「橙花」。橙花帶來幸福與歡樂的感覺，幫助你保持心情愉悅555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555。",
    "喜歡": "今天適合你的精油是「檸檬草」。檸檬草可以提神醒腦，增強你對事物的熱情。",
    "悲傷": "今天適合你的精油是「薰衣草」。薰衣草有助於舒緩悲傷情緒，帶來寧靜與安定感。",
  ...
  Future<void> fetchClientData() async {
    String clientId = '23'; //換成從上一個頁面傳過來的客戶id
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          if (highestEmotion != null && highestEmotion!.length == 2) {
            highestEmotionName = emotionTranslations[highestEmotion![0].toString()] ?? "未知情緒";
            highestEmotionValue = double.tryParse(highestEmotion![1].toString()) ?? 0.0;
          }
          isLoading = false;
        });
  ...
  void convertDailyDataToEmotions() {
    if (dailyData != null) {
      emotions = {
        "開心": (dailyData!["happiness"] as num).toDouble().round(), // 使用 `num` 類型，然後轉換為 `double`
  ...
  void convertWeeklyDataToFlSpot() {
    if (weeklyData != null) {
      ...
      for (int index = 0; index < positiveSums.length; index++) {
        double value = (positiveSums[index] as num).toDouble(); // 使用 `num` 類型，然後轉換為 `double`
        if (value != 1000.0) {
      ...
      for (int index = 0; index < negativeSums.length; index++) {
        double value = (negativeSums[index] as num).toDouble(); // 使用 `num` 類型，然後轉換為 `double`
        if (value != 1000.0) {
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: Colors.black26, blurRadius: 6.v, offset: Offset(0.v, 3.v)),
                  ],
                ),
                child: Column(
                  children: [
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(
            text,
            style: TextStyle(fontSize: 14.2.v, fontWeight: FontWeight.bold, color: color),
          ),
        ],
      ),
    );
            ...
            leftTitles: AxisTitles(
              sideTitles: SideTitles(
                ...
                getTitlesWidget: (value, meta) {
                  ...
                  switch (value.toInt()) {
                    case 0:
                      return Text('0%', style: labelTextStyle, textAlign: TextAlign.right);
                    case 20:
                      return Text('20%', style: labelTextStyle, textAlign: TextAlign.right);
                    case 40:
                      return Text('40%', style: labelTextStyle, textAlign: TextAlign.right);
                    case 60:
                      return Text('60%', style: labelTextStyle, textAlign: TextAlign.right);
                    case 80:
                      return Text('80%', style: labelTextStyle, textAlign: TextAlign.right);
                    case 100:
                      return Text('100%', style: labelTextStyle, textAlign: TextAlign.right);
                    default:
                      return Text('');
                  }
                },
...
Future<void> saveClientID(String clientId) async {
  final prefs = await SharedPreferences.getInstance();
  await prefs.setString('receiver_id', clientId); // Save client_id as receiver_id
