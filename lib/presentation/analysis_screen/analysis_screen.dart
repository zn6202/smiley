...
class _AnalysisScreenState extends State<AnalysisScreen> {
  ...
  Future<void> fetchData() async {
    ...
    DateTime lastDayOfLastMonth =
        DateTime(firstDayOfLastMonth.year, firstDayOfLastMonth.month + 1, 0);
    // 計算上個月有幾天
    int daysDifference =
        lastDayOfLastMonth.difference(firstDayOfLastMonth).inDays;
    // 今日星期幾
    ...
    if ((isSelected[1] && weekDayName == "星期一") ||
        (isSelected[2] && isStartOfMonth)) {
      ...
      print(
          '有寫日記的天數: $time positiveSums: $positiveSums negativeSums: $negativeSums');
      if (time == 0) {
        setState(() {
          haveDiary = false;
        });
      ...
      //   other(不顯示在今日圖表)
      int emoSum = testData['happiness'] +
          testData['like'] +
          testData['sadness'] +
          testData['disgust'] +
          testData['anger'];
      testData['happiness'] = double.parse(
          (testData['happiness'] * 100 / emoSum).toStringAsFixed(1));
      testData['like'] =
          double.parse((testData['like'] * 100 / emoSum).toStringAsFixed(1));
      testData['sadness'] =
          double.parse((testData['sadness'] * 100 / emoSum).toStringAsFixed(1));
      testData['disgust'] =
          double.parse((testData['disgust'] * 100 / emoSum).toStringAsFixed(1));
      testData['anger'] =
          double.parse((testData['anger'] * 100 / emoSum).toStringAsFixed(1));
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (!(isSelected[0] && testData['other'] == 100)) ...[
                        Text(
                          titleText,
                          style: TextStyle(
                            fontSize: 20.fSize,
                      ...
                      if (haveDiary)
                        if (isSelected[0]) // 如果有日記且選擇了"今日"
                          Column(
                            children: [
                              // 當 other == 100 顯示文字和圖片
                              if (testData['other'] == 100)
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '今天的你，情緒如止水般平靜，彷彿成為一片無波無瀾、清澈透明的湖面，靜靜地包容著各種情緒的流動。',
                                      style: TextStyle(
                                        fontSize: 14.5.fSize,
                                        fontWeight: FontWeight.w700,
                                        color: Color(0xFF545453),
                                ...
                                child: LineChart(LineChartData(
                                  ...
                                  lineBarsData: [
                                    LineChartBarData(
                                      ...
                                      isCurved: true,
                                      color: Color(0xFFA7BA89), //0xFF7DA8E8
                                      barWidth: 4,
                                      belowBarData:
                                    ...
                                    LineChartBarData(
                                      ...
                                      isCurved: true,
                                      color: Color(0xFF7DA8E8), //0xFFA7BA89
                                      barWidth: 4,
                                      belowBarData:
                                          BarAreaData(show: false),
                                      dotData: FlDotData(show: false),
