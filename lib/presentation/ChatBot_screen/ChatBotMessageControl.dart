...
class MessageProvider with ChangeNotifier {
  ...
  String getUserDiary(){
    // 取得並回傳User寫的日記並
    // String newDiary = "「紀錄時間：『2024年8月20日，星期二。』。日記內容：『今天是個特別讓人心動的日子！早上在咖啡店排隊時，偶然間與一個陌生人聊了起來。他對咖啡的熱情和深厚的知識讓我感到非常有趣，並且他那種真誠的微笑讓人很難不喜歡上他。中午時，我居然又在公園裡碰到了他！但這次我們坐下來聊了很久，話題從咖啡延展到音樂、旅行和書籍。我們發現彼此有很多共同的愛好，這種感覺實在太美好了～下午我回到家後，整個人都充滿了愉快的情緒。每當想起我們的對話，我都忍不住微笑。那種心動的感覺真是讓人難以忘懷。今天的每一刻都讓我感到無比愉快，心裡充滿了對未來的期待和喜歡的感覺。』」";
    // String newDiary = "紀錄時間：『2024年8月20日，星期二。』。日記內容：『早上收到消息，一個很親近的朋友突然決定搬到其他城市去工作。這個消息對我來說非常震驚和難過，因為我們一起度過了很多快樂的時光，現在突然要分開，心裡感到無比的失落。工作中也沒有什麼好消息，幾個重要的項目進展不順利，讓我感到壓力山大。同事們似乎也很忙碌，沒有時間互相支持和幫助，這讓我感到更加孤單和無助。午餐時，本來想給自己買點喜歡的食物來振作一下心情，結果卻發現自己最愛的那家餐廳今天關門了。這小小的打擊讓我更覺得整個世界都在與我作對。下午試著集中精神工作，但心情一直無法平靜下來，總是想起朋友離開的事。晚上回到家，感覺整個人都被悲傷和孤獨包圍，只能靜靜地躺在床上，默默流淚。』";
    // String newDiary = "「紀錄時間：『2024年8月20日，星期二。』。日記內容：『今天真是讓人惱火的一天！！！！早上在公司，老闆無緣無故對我發火，責怪我沒有完成一個根本不屬於我的任務。我試圖解釋，但他根本不聽，甚至威脅要扣我的薪水。這讓我感到極度不公平和憤怒午餐時，本來打算和同事們一起放鬆一下，但餐廳服務態度極差，餐點還上錯了兩次。這一系列的小事累 積下來，讓我心裡的怒火越來越旺。下午回到辦公室，又收到客戶的無理要求和抱怨，這些明顯是他們自己的問題，卻都推到我頭上。我感到非常無力和憤怒，但只能強忍著，因為知道即使表達出來也無濟於事。回家路上還遇到塞車，其他車輛的惡劣行為與三寶技術讓我心情更加煩躁。回到家後，本來期待能放鬆一下，才發現忘記停水公告，澡都無法洗了…』」";
    // String newDiary = "「紀錄時間：『2024年8月20日，星期二。』。日記內容：『今天有夠糟糕。早上剛起床，我就感覺到肚子一陣翻騰，像是吃壞了什麼東西。強忍著不適去上班，結果途中還遇到堵車，車裡悶熱的空氣讓我感到更加噁心⋯到了公司後，狀況並沒有好轉⋯同事帶來的早餐味道讓我更加難受。忍著不適處理工作，但無法集中精神，感覺頭昏眼花。午飯時間，同事們邀我去餐廳吃飯，我只能勉強陪同，但一進餐廳，濃烈的食物氣味讓我幾乎要吐出來。下午請了病假回家，一路上感覺像在走鋼絲，深怕自己會在大街上吐出來。回到家裡，只能躺在床上休息，但那股噁心的感覺始終揮之不去，整個人疲憊不堪。噩夢般的一天能快點結束。』」";
    String newDiary = "「紀錄時間：『2024年8月25日，星期日。』。日記內容：『今天是一個美好的日子！一大早醒 來，陽光透過窗戶灑進房間，感覺整個人都被幸福包圍了。早餐時，我和家人一起享用了豐盛的早點，大家談笑風生，氣氛非常愉快～～下午我獨自去公園散步，微風輕拂，花草的香氣讓人心曠神怡。晚上，我邀請朋友來家裡，一起做了一頓美味的晚餐，點上蠟燭、放著柔和的音樂，一切都顯得那麼愉悅和溫馨！看著大家的笑容，我也感受到滿滿的幸福。在這樣的一天結束時，我真心感激生命中的每一個美好時刻，感覺自己的心裡充滿了愛和感恩。』」";
    String userDiary = "我寫了一篇日記：${newDiary}";
    return userDiary;
  }
  // 將User寫的日記，並傳給助手，等待回覆
  Future<Map<String, String>> sendUserDiaryToAssistant(String diaryMessage) async {
    final message = diaryMessage;
    print(diaryMessage);
    final response = await http.post(                                                   //     發送HTTP POST請求至後端並等待回應，傳送訊息，並等待回覆
      Uri.parse('http://10.0.2.2:5001/send_message_to_python'),                         //       設定請求的URL，指向本地開發環境的Python伺服器
      headers: <String, String>{'Content-Type': 'application/json; charset=utf-8',},    //        設定HTTP請求的標頭，指定內容類型為JSON，編碼為UTF-8
